...
export const themes = {
  watercolor: {
    light: {
      ...
      segmentation: '#C4C4C4',
      inputBorder: '#E0E0E0',
      profileBackground: require('../assets/watercolorLightProfileBG.jpg'),
    ...
    dark: {
      ...
      segmentation: '#474747',
      inputBorder: '#434343',
      profileBackground: require('../assets/watercolorDarkProfileBG.jpg'),
  ...
  ashgreen: {
    light: {
      ...
      segmentation: '#C4C4C4',
      inputBorder: '#E0E0E0',
      profileBackground: require('../assets/ashgreenLightProfileBG.png'),
    ...
    dark: {
      ...
      segmentation: '#474747',
      inputBorder: '#434343',
      profileBackground: require('../assets/ashgreenDarkProfileBG.jpg'),
